...
/** JDBC Connection을 프록시하여 PreparedStatement 및 Statement를 가로채는 래퍼 클래스입니다. */
public class ApmProxyConnection implements Connection {

  private final Connection delegate;
  private final ApmProperties properties;

  public ApmProxyConnection(Connection delegate, ApmProperties properties) {
  ...
  public Statement createStatement() throws SQLException {
    return new ApmProxyStatement(delegate.createStatement(), properties);
  }

  @Override
  public Statement createStatement(int resultSetType, int resultSetConcurrency)
      throws SQLException {
    return new ApmProxyStatement(
        delegate.createStatement(resultSetType, resultSetConcurrency), properties);
  }
  ...
  public PreparedStatement prepareStatement(String sql) throws SQLException {
    return new ApmProxyPreparedStatement(delegate.prepareStatement(sql), sql, properties);
  }

  @Override
  public PreparedStatement prepareStatement(String sql, int resultSetType, int resultSetConcurrency)
      throws SQLException {
    return new ApmProxyPreparedStatement(
